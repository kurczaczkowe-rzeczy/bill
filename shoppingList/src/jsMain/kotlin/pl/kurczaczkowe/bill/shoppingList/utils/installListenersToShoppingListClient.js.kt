...
private typealias ShoppingListChangeListener = (listId: String, action: (payload: dynamic) -> dynamic) -> Subscription
...
fun installListenersToShoppingListClient() {
    ...
    ensureMethod<ShoppingListChangeListener>(shoppingListClientCtor, "listenForShoppingListChanges") { listId: String, action: (payload: dynamic) -> dynamic ->
