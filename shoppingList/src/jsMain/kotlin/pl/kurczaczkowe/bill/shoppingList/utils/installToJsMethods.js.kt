...
fun installToJsMethods() {
    ...
    val categoryWithProductsCtor: dynamic = CategoryWithProducts::class.js
    ...
    ensureMethod(categoryWithProductsCtor) { self -> self.unsafeCast<CategoryWithProducts>().toJs() }
